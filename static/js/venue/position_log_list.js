...
var vue = new Vue({
    ...
    methods: {
        ...
        searchClick: function (type) {
            ...
            axios.post('/xfxhapi/zwlog/page', params).then(function (res) {
        ...
        deleteSubmit: function (val) {
            this.$refs[val].validate((valid) => {
                if (valid) {
                    ...
                    this.$confirm('确定清空' + date1 + '至' + date3 + '的日志信息?', '提示', {
                        ...
                        axios.post('/xfxhapi/zwlog/doDeleteByRzsj', params).then(function (res) {
